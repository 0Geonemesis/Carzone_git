...
public class FrmReporteVentasIngresos extends JFrame {
    ...
    private JLabel lblTotalVentas, lblMontoVentas, lblMontoIngresos;

    private List<Venta> ventasActuales;
    private String rangoDescripcionActual = "Todas las fechas";

    public FrmReporteVentasIngresos(Usuario usuarioActual) {
    ...
    private void initComponents() {
        setTitle("CarZone — Reporte de Ventas e Ingresos");
        setSize(1080, 680);
    ...
    private JPanel crearHeader() {
        ...
        JLabel lblTitulo = new JLabel("CARZONE  |  Reporte de Ventas e Ingresos");
    ...
    private JPanel crearPanelResumen() {
        ...
        lblMontoVentas = crearTarjetaMetrica("S/. 0.00");
        lblMontoIngresos = crearTarjetaMetrica("S/. 0.00");

        p.add(contenedorTarjeta("Ventas en el reporte", lblTotalVentas, C_AZUL));
        p.add(contenedorTarjeta("Monto total de ventas", lblMontoVentas, new Color(140, 80, 20)));
        p.add(contenedorTarjeta("Ingresos (completadas)", lblMontoIngresos, C_VERDE));
        return p;
    }
    ...
    private JScrollPane crearPanelTabla() {
        String[] columnas = {"ID Venta", "Fecha", "Cliente", "Auto", "Vendedor", "Estado", "Venta (S/.)", "Ingreso (S/.)"};
        ...
        int[] anchos = {65, 110, 150, 190, 90, 80, 90, 90};
    ...
    private void refrescarTabla() {
        ...
        List<Venta> completadas = filtrarSoloCompletadas(ventasActuales);
        ...
        for (Venta v : completadas) {
            ...
            modeloTabla.addRow(new Object[]{
                ...
                esCompletada ? String.format("%,.2f", ingreso) : "-"
            });
        ...
        lblTotalVentas.setText(String.valueOf(completadas.size()));
        lblMontoVentas.setText(String.format("S/. %,.2f", totalVentas));
        lblMontoIngresos.setText(String.format("S/. %,.2f", totalIngresos));
    }
    ...
    private void descargarPDF() {
        ...
        chooser.setDialogTitle("Guardar Reporte de Ventas e Ingresos");
        String nombreSugerido = "ReporteVentasIngresos_" + new SimpleDateFormat("yyyyMMdd_HHmmss").format(new java.util.Date()) + ".pdf";
        ...
        try {
            Reporte reporte = ReporteFactory.crear(
                    ReporteFactory.TIPO_VENTAS_INGRESOS,
