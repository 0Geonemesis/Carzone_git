...
public class FrmReporteVentasAnuladas extends JFrame {
    ...
    private JLabel lblTotalAnuladas, lblMontoAnulado;

    private List<Venta> ventasActuales;
    private String rangoDescripcionActual = "Todas las fechas";

    public FrmReporteVentasAnuladas(Usuario usuarioActual) {
    ...
    private void initComponents() {
        setTitle("CarZone — Reporte de Ventas Anuladas");
        setSize(1080, 680);
    ...
    private JPanel crearHeader() {
        ...
        JLabel lblTitulo = new JLabel("CARZONE  |  Reporte de Ventas Anuladas");
    ...
    private JPanel crearPanelResumen() {
        ...
        lblTotalAnuladas = crearTarjetaMetrica("0");
        lblMontoAnulado = crearTarjetaMetrica("S/. 0.00");

        p.add(contenedorTarjeta("Ventas anuladas en el reporte", lblTotalAnuladas, C_ROJO));
        p.add(contenedorTarjeta("Monto total anulado", lblMontoAnulado, C_AZUL));
        return p;
    }
    ...
    private JPanel contenedorTarjeta(String titulo, JLabel lblValor, Color color) {
        ...
        lblTit.setForeground(new Color(230, 220, 220));
    ...
    private JPanel crearPanelFiltro() {
        ...
        cmbFechaRapida = new JComboBox<>(new String[]{
            "Fecha exacta...", "Anuladas de hoy", "Última semana", "Último mes", "Último año"
        });
        ...
        cmbFechaRapida.addActionListener(e -> {
            ...
            switch (idx) {
                case 1:
                    desde = hoy;
                    etiqueta = "Ventas anuladas de hoy";
                    break;
                case 2:
                    desde = hoy.minusWeeks(1);
                    etiqueta = "Ventas anuladas de la última semana";
                    break;
                case 3:
                    desde = hoy.minusMonths(1);
                    etiqueta = "Ventas anuladas del último mes";
                    break;
                default:
                    desde = hoy.minusYears(1);
                    etiqueta = "Ventas anuladas del último año";
                    break;
            }
    ...
    private void aplicarFiltroRapido(String etiqueta, LocalDate desdeLd, LocalDate hastaLd) {
        ...
        ventasActuales = ventaDAO.buscarPorCriteria(null, null, ESTADO_ANULADA, desde, hasta);
    ...
    private String calcularDescripcionFecha(List<Venta> ventas) {
        if (ventas == null || ventas.isEmpty()) {
            return "Sin ventas anuladas registradas";
        }
    ...
    private JPanel crearPanelBotones() {
        ...
        estilizarBoton(btnDescargar, new Color(30, 120, 60), Color.WHITE);
    ...
    private void cargarTodas() {
        ventasActuales = ventaDAO.buscarPorCriteria(null, null, ESTADO_ANULADA, null, null);
    ...
    private void refrescarTabla() {
        ...
        lblTotalAnuladas.setText(String.valueOf(ventasActuales.size()));
        lblMontoAnulado.setText(String.format("S/. %,.2f", total));
    }
    ...
    private void descargarPDF() {
        ...
        chooser.setDialogTitle("Guardar Reporte de Ventas Anuladas");
        String nombreSugerido = "ReporteVentasAnuladas_" + new SimpleDateFormat("yyyyMMdd_HHmmss").format(new java.util.Date()) + ".pdf";
        ...
        try {
            Reporte reporte = ReporteFactory.crear(
                    ReporteFactory.TIPO_VENTAS_ANULADAS,
                    ventasActuales,
