...
public class ReporteVentasAnuladas implements Reporte {
    ...
    public ReporteVentasAnuladas(List<Venta> ventas, String rangoDescripcion, String usuarioGenerador) {
        this.ventas = ventas;
    ...
    public void exportarPDF(String rutaArchivo) {
        ...
        if (ventas == null || ventas.isEmpty()) {
            pdf.texto(MARGEN_IZQ, y + 10, "No se encontraron ventas anuladas para el criterio seleccionado.", 10, false);
        } else {
            ...
            y += 18;
            pdf.texto(MARGEN_IZQ, y, "Total de ventas anuladas listadas: " + contador, 10, true);
            y += 16;
            pdf.texto(MARGEN_IZQ, y, "Monto total anulado: S/ " + moneda.format(total), 10, true);
        }
    ...
    private float dibujarEncabezado(DocumentoPDF pdf) {
        ...
        pdf.texto(MARGEN_IZQ, 42, "Reporte de Ventas Anuladas (Eliminacion Logica)", 11, false, 1f, 1f, 1f);
